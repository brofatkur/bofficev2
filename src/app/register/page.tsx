  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col justify-center items-center p-4">
      <div className="max-w-xl w-full bg-slate-900 border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-2xl space-y-6 relative overflow-hidden">
        ...
        {submitted ? (
          <div className="bg-slate-950 p-6 rounded-2xl border border-emerald-500/30 text-center space-y-4 animate-fadeIn">
            <div className="w-14 h-14 bg-emerald-500/20 text-emerald-400 rounded-2xl flex items-center justify-center mx-auto">
              <CheckCircle2 className="w-8 h-8" />
            </div>
            <div>
              <h2 className="text-lg font-extrabold text-white">Pendaftaran Berhasil Dikirim!</h2>
            ...
            <div className="pt-2">
              <Link
                href="/attendance"
                className="inline-flex items-center gap-2 px-5 py-2.5 bg-blue-600 hover:bg-blue-500 text-white font-bold rounded-xl text-xs transition-all shadow-md"
              >
          ...
          <form onSubmit={handleSubmit} className="space-y-4 text-xs">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div>
                <label className="block font-semibold text-slate-300 mb-1">Pilihan Layanan *</label>
                <select
              ...
              <div>
                <label className="block font-semibold text-slate-300 mb-1">Cabang Tujuan *</label>
                <select
                  value={form.branchId}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              <div className="sm:col-span-1">
                <label className="block font-semibold text-slate-300 mb-1">Bentuk Badan Usaha *</label>
                <select
              ...
              <div className="sm:col-span-2">
                <label className="block font-semibold text-slate-300 mb-1">Nama Perusahaan / Lembaga *</label>
                <input
                  type="text"
                  required
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              <div>
                <label className="block font-semibold text-slate-300 mb-1">Nama PIC *</label>
                <input
                  type="text"
                  required
              ...
              <div>
                <label className="block font-semibold text-slate-300 mb-1">No. WhatsApp PIC *</label>
                <input
                  type="text"
                  required
                  ...
                  className="w-full px-3 py-2.5 bg-slate-950 border border-slate-700 rounded-xl text-white font-mono focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
              </div>
              <div>
                <label className="block font-semibold text-slate-300 mb-1">Email PIC *</label>
                <input
                  type="email"
                  required
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div>
                <label className="block font-semibold text-slate-300 mb-1">NPWP Perusahaan (opsional)</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block font-semibold text-slate-300 mb-1">NIB Perusahaan (opsional)</label>
                <input
                  type="text"
            ...
            <div>
              <label className="block font-semibold text-slate-300 mb-1">Alamat Korespondensi / Asal *</label>
              <textarea
                rows={2}
                required
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3.5 bg-blue-600 hover:bg-blue-500 text-white font-extrabold rounded-2xl shadow-lg shadow-blue-600/30 transition-all text-sm disabled:opacity-50 flex items-center justify-center gap-2"
            >
